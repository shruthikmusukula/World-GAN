...
from models import calc_gradient_penalty_ct, save_networks
...
def train_single_scale_ct(D, G, reals, generators, noise_maps, input_from_prev_scale, noise_amplitudes, opt):
    ...
    for epoch in tqdm(range(opt.niter)):
        ...
        for curr_inp in range(group_steps):
            ...
            for j in range(opt.Dsteps):
                ...
                # Gradient Penalty
                gradient_penalty = calc_gradient_penalty_ct(D, real, fake, opt.lambda_grad, opt.device)
